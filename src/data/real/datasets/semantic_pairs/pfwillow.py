...
class PFWillowDataset(CorrespondenceDataset):
    ...
    def __init__(self, benchmark, datapath, thres, split, augmentation, feature_size,receptive_field_size=35):
        r"""PF-WILLOW dataset constructor"""
        super(PFWillowDataset, self).__init__(benchmark, datapath, thres, split, augmentation, feature_size,receptive_field_size)
